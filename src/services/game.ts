...
// const test = async () => {
//     const responses = Array.from({ length: 5 }, (_, i) => (i+2)*2)
//     .map( async (size) => {
//         const result = await getGamesTest(size)
//         console.log({size, result})
//     })

// }

// const getGamesTest = async (size: number) => {
...
//     //     // releaseYear: 2009
//     // }, size);
//     const response = await apiGetGameDetails(404446);
